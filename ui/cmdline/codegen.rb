...
module CodeGenerator
  ...
  class Parser
    ...
    MACROS = %w(OBV V O H L C MINV MINO MINH MINL MINC MAXV MAXO MAXH MAXL MAXC AVGV AVGO AVGH AVGL AVGC EMAV EMAO EMAH EMAL 
    ...
    CDL_HAMMER CDL_HANGMAN CDL_INVERTED_HAMMER CDL_SHOOTING_STAR EPS_TTM REVENUE_TTM NET_INCOME_TTM ROE EPS SAR ROC 
    ...
    STARC_UPPER STARC_LOWER PIVOT PIVOT_S PIVOT_R MAX MIN NATR)
