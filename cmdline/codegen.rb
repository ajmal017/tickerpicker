...
module CodeGenerator
  ...
  class Parser
    ...
    RSI WILLIAMS_R ATR MACDS MACDH MACD MOMENTUM BOP ADXR ADX ACCELERATION_UPPER ACCELERATION_LOWER ULTOSC 
    ...
    DATE_MIN_C ABS DAYS_AGO PIVOT PIVOT_S PIVOT_R MAX MIN NATR V O H L C)
